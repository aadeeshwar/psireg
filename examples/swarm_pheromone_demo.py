...
def demonstrate_pheromone_field():
    ...
    print("  DEMAND_REDUCTION at (4,4): 1.0")
    print("  FREQUENCY_SUPPORT at (2,2): 0.8")
    print("  ECONOMIC_SIGNAL at (6,6): 0.6")
...
def demonstrate_swarm_coordination():
    ...
    for scenario_idx, scenario in enumerate(scenarios):
        ...
        for agent in agents["battery"]:
            ...
            optimal_power = agent.calculate_optimal_power(forecast_load, forecast_generation, forecast_prices)
        ...
        for agent in agents["demand"]:
            ...
            optimal_demand = agent.calculate_optimal_demand(forecast_prices, forecast_generation, forecast_stress)
...
def demonstrate_emergency_response():
    ...
    print("Emergency agents registered")
    ...
    for step_idx, step_conditions in enumerate(emergency_steps):
        ...
        if step_conditions["stress"] > 0.8:
            ...
            swarm_bus.deposit_pheromone(battery_agent.agent_id, PheromoneType.EMERGENCY_RESPONSE, emergency_strength)
            swarm_bus.deposit_pheromone(
                demand_agent.agent_id, PheromoneType.EMERGENCY_RESPONSE, emergency_strength * 0.8
            )
        ...
        # Battery response
        battery_power = battery_agent.calculate_optimal_power([50.0] * 4, [30.0] * 4, forecast_prices)
        battery_agent.execute_control_action(battery_power)

        # Demand response
        demand_optimal = demand_agent.calculate_optimal_demand(forecast_prices, [30.0] * 4, forecast_stress)
